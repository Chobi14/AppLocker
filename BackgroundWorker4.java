...
public class BackgroundWorker4 extends AsyncTask <String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String ln_url = "http://moviles2016.esy.es/desaparta.php";
        if(type.equals("desaparta")) {
            try {
                String user_des = params[1];
                ...
                String post_data = URLEncoder.encode("user_des","UTF-8")+"="+URLEncoder.encode(user_des,"UTF-8");
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.equals("NULL"))  {
            ...
            alertDialog.setMessage("Ahora puedes apartar otro casillero");
            alertDialog.setCancelable(false);
